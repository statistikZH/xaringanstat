...
<a href="https://twitter.com/statistik_zh" style="text-decoration: none; border-bottom: 5px solid  #009ee0; color: #919191;"><i class="fa fa-twitter fa-fw"></i>@statistik_zh</a><br> 
<a href="https://github.com/statistikZH" style="text-decoration: none; border-bottom: 5px solid  #009ee0; color: #919191;"><i class="fa fa-github fa-fw"></i>Statistisches Amt Kanton Zürich</a><br> 
<a href="mailto:datashop@statistik.zh.ch" style="text-decoration: none; border-bottom: 5px solid  #009ee0; color: #919191;"><i class="fa fa-paper-plane fa-fw"></i>datashop@statistik.zh.ch</a><br>'
output:
  xaringan::moon_reader:
    css: ["lib/zh_cd_statistik.css", "https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css", "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"]
    nature:
